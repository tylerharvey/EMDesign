...
optimize_many_shapes(mir,col,mir.electrode_z_indices,mir.electrode_r_indices,z_curv_z_indices_list=None,z_curv_r_indices_list=None,end_z_indices_list=end_z_indices_list,end_r_indices_list=end_r_indices_list,automate_present_curvature=automate_curvature,enforce_smoothness=enforce_smoothness,z_min=z_min,z_max=z_max,r_min=r_min,r_max=None,c3_target=target_c3,simplex_scale=simplex_scale,options={'disp':True,'xatol':0.01,'fatol':0.001,'adaptive':True,'initial_simplex':initial_simplex,'return_all':True}) # ,'maxfev':100000 #,method='Nelder-Mead',manual_bounds=True,options={'disp':True,'xatol':0.01,'fatol':0.001,'adaptive':True,'initial_simplex':None})
